        ...
        <div ng-controller="editCtrl">
            ...
            <div class="tab-v1">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#patient" data-toggle="tab">Patient Basic Info</a></li>
                    <li><a href="#history" data-toggle="tab">Check up History</a></li>
                </ul>
                <div class="tab-content">
                    <div class="hoz-space"></div>
                    <div class="tab-pane fade in active" id="patient">
                        <form ng-submit="processPatientInfo()">
